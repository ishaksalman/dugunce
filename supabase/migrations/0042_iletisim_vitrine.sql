-- =============================================================================
-- Düğünce · 0042 · get_venue_detail: contact_phone_norm vitrine çıkıyor
--
-- Telefon ve WhatsApp butonları için 10 haneye normalize edilmiş numara
-- gerekiyor — `contact_phone` serbest metin (ham kullanıcı/kaynak yazımı),
-- `tel:`/`wa.me` bağlantısı için güvenilir değil. `contact_phone_norm`
-- zaten üretilmiş kolon (0029); bugüne kadar yalnızca mükerrer kontrolünde
-- kullanılıyordu, vitrine hiç çıkmıyordu.
--
-- EN SON sürümden (0041) türetildi — yalnızca `v.contact_phone_norm`
-- select listesine ekleniyor, başka hiçbir şey değişmiyor.
-- =============================================================================
